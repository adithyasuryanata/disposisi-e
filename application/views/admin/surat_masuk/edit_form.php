            ...
            <div class="card-body">
                <form action="<?php echo site_url('admin/surat_masuk/edit') ?>" method="post"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="perihal" value="<?= $surat->perihal; ?>"
                            placeholder="PERIHAL SURAT" required>
                    </div>
                    <div class="mb-3">
                        <label>TANGGAL SURAT <code>*</code></label>
                        <input class="form-control" type="date" name="tgl_surat" value="<?= $surat->tgl_surat; ?>"
                            placeholder="TANGGAL SURAT" required>
                    </div>
                    <div class="mb-3">
                        <label>SURAT DARI <code>*</code></label>
                        <input class="form-control" type="text" name="surat_from" value="<?= $surat->surat_from; ?>"
                            placeholder="SURAT DARI" required>
                    </div>
                    <div class="mb-3">
                        <label>TUJUAN SURAT <code>*</code></label>
                        <input class="form-control" type="text" name="surat_to" value="<?= $surat->surat_to; ?>"
                            placeholder="TUJUAN SURAT" required>
                    </div>
                    <div class="mb-3">
                        <label>TANGGAL TERIMA SURAT <code>*</code></label>
                        <input class="form-control" type="date" name="tgl_terima" value="<?= $surat->tgl_surat; ?>"
                            placeholder="TANGGAL TERIMA SURAT" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" placeholder="KETERANGAN" name="keterangan" id="floatingTextarea2"
                            style="height: 100px"><?= $surat->keterangan; ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="image">BERKAS SURAT (Photo)</label>
                        <input type="file" class="form-control " id="inputGroupFile01" name="image"> <input
                            class="form-control" type="hidden" name="old_image" value="<?= $surat->image; ?>"
                            required />
                    </div>
